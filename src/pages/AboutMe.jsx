  ...
  return (
    <PopupWrapper>
      <div className="p-10 text-left">
        {/* Title */}
        <h1 className="text-3xl font-bold mb-6 mt-6">About Me</h1>
        ...
        {/* Education Section */}
        <div className="mb-8">
          <h2 className="text-2xl font-semibold mb-3 text-left">Education</h2>
          <ul className="list-disc list-inside space-y-2 text-left">
            <li>Northwestern University – B.A. in Computer Science & Statistics (Expected 2027)</li>
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-semibold mb-3 text-left">Work Experience</h2>
          <ul className="list-disc list-inside space-y-2 text-left">
        ...
        <div className="mb-8">
          <h2 className="text-2xl font-semibold mb-3 text-left">Extracurriculars</h2>
          <ul className="list-disc list-inside space-y-2 text-left">
            <li>FutureDev - Director of Education</li>
            <li>Business Analust - Consult Your Community</li>
          </ul>
        </div>
        ...
        {/* Hobbies Section */}
        <div className="mb-8">
          <h2 className="text-2xl font-semibold mb-3 text-left">Hobbies & Interests!</h2>
          <ul className="list-disc list-inside space-y-2 text-left">
